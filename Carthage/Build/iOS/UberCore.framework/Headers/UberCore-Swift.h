...
SWIFT_MODULE_NAMESPACE_PUSH("UberCore")
@class UBSDKScope;
@class NSCoder;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKCallbackURIType, "CallbackURIType") {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKDeeplinkErrorType, "DeeplinkErrorType") {
...
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKDeeplinkFallbackType, "DeeplinkFallbackType") {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, UBSDKAuthenticationErrorType, "UberAuthenticationErrorType") {
...
typedef SWIFT_ENUM(NSInteger, UberButtonColor) {
...
typedef SWIFT_ENUM(NSInteger, UberButtonColorStyle) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, UberScopeType) {
